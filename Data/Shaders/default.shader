...
{
    vec3 light = vec3(0.1);
    light += calculateLight(light0, ShadowMap0); //shadowCoord0,
    light += calculateLight(light1, ShadowMap1); //shadowCoord1,
    light += calculateLight(light2, ShadowMap2); //shadowCoord2,
    light += calculateLight(light3, ShadowMap3); //shadowCoord3,
    light += calculateLight(light4, ShadowMap4); //shadowCoord4,
    light += calculateLight(light5, ShadowMap5); //shadowCoord5,
    light += calculateLight(light6, ShadowMap6); //shadowCoord6,
    light += calculateLight(light7, ShadowMap7); //shadowCoord7,
    return light;
}
